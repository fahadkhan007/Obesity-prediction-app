...
target_encoder = joblib.load("modelnb/models/target_label_encoder.pkl")
scaler = joblib.load("modelnb/models/robust_scaler.pkl")
feature_columns = joblib.load("modelnb/models/feature_columns.pkl")
model = joblib.load("modelnb/models/random_forest_model.pkl")
